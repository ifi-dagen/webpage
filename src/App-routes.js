    ...
    return (
      <Switch>
        ...
        <Route
          ...
          path="/program"
          render={(prop) => (
            <Program {...prop} store={this.props.store} published={true} />
          )}
        />
        <Route
          exact
        ...
        />
        <Route exact path="/studenter" render={(prop) => <Studenter />} />
        <Route
          exact
          path="/frivillig"
        ...
        <Route
          ...
          path="/stander"
          render={(prop) => (
            <Stander {...prop} store={this.props.store} testmode={true} />
          )}
        />
        <Route
          exact
          path="/stander/:dag/:bedrift"
          render={(prop) => <BedriftStand />}
        />
        <Route
          exact
          path="/bedrift"
