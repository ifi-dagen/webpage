...
const stand_info =
{
  ...
  "dag2": {
    ...
    "Clave": {
      bedriftnavn: "Clave",
      beskrivelse: "Clave er en gjeng flinke designere og utviklere med stort engasjement for det vi driver med. Vi brenner for teknologi, innovasjon og å lage de aller beste løsningene for menneskene som skal bruke dem. Vi er stolte av jobbene vi gjør og enda stoltere av relasjonene vi bygger med kundene våre.\nClave jobber med i ulike bransjer med flere forskjellige spennende kunder. Fellesnevneren for alle våre prosjekter er at vi bidra med vår spisskompetanse og jobber tett sammen med kunden for å sammen løse de målsetningene som er satt.",
      logonavn: "clave.png",
      video:"",
