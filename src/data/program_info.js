...
const aapningshilsen = 'følg med på Instagram'
...
const program_info = [
    {
        ...
        beskrivelse:
            'Under Karriereuka UiO har Kripos holdt en CTF, nå annonseres vinnerne!',
        link:
            'https://uio.zoom.us/webinar/register/WN_adAC6Ap8QEKEscLLnxGITw?fbclid=IwAR32ym3xFAOX0QVCTt6j4H2ZpzfAkeOIDW0uwEE7H9Gc9c7Bjbll9j1Afno',
        bilde: '',
        alt_tekst: '',
    },
    {
    ...
    },
    {
        ...
        beskrivelse:
            'Kom og møt en fremtidig kollega! zoomrommene er åpne kl 11-13, men bedrift-sidene vil være åpne til kl 18',
        link: '/#standomraadet',
        bilde: 'dagen_logo.svg',
        alt_tekst: 'dagen at ifi sin logo',
    },
    //foredragsrekke dag1
    {
        ...
        id: 3,
        tittel:
            'Event Driven Design and Architecture in DNB Emerging Technologies',
    ...
    },
    {
        ...
        foredragsholder: 'FFI',
        beskrivelse:
            'To av årets sommerstudenter ved FFI (derav en fra UiO) programmerte en mikrokontroller til å utføre kryptografi som er sikker mot kvantedatamaskiner. Etter å ha utvekslet nøkler kan man sende meldinger fram og tilbake mellom dingsene. Foredraget forklarer hvorfor dette høyaktuelle temaet er viktig, fulgt av en rask demonstrasjon.',
        link: zoomlinkdag1,
    ...
    },
    {
        ...
        id: 7,
        tittel:
            'Det skal være lett å gjøre rett - eller hvordan lage nettbank med 20 team og samtidig sove godt om natten',
        start: new Date(2020, 8, dag1, 15, 0, 0, 0),
        slutt: new Date(2020, 8, dag1, 15, 25, 0, 0),
        foredragsholder: 'SpareBank 1 Utvikling',
        beskrivelse:
            'Kom og hør hvordan noen få byggescript vi lagde i 2013, har hjulpet oss på reisen fra tre til over 20 team og utviklet seg til å bli en av bærebjelkene for kontinuerlig teknologiutvikling og forbedring i SpareBank 1.',
        link: zoomlinkdag1,
    ...
    },
    {
        ...
        beskrivelse:
            "Quantum Computing har allerede begynt å vise potensiale for å bli en 'game changer' i måten vi løser noen av verdens vanskeligste problemer. I dette foredraget skal jeg fortelle hvordan vi i Accenture jobbet sammen med BMW for å løse et av deres største optimaliseringseringsproblemer hos deres fabrikkroboter ved å bruke Quantumteknologi.",
        link: zoomlinkdag1,
    ...
    },
    {
        ...
        id: 18,
        tittel:
            'Jesper fikser jernbanen med Azure IoT og hjemmesnekret elektronikk',
        start: new Date(2020, 8, dag2, 13, 30, 0, 0),
        slutt: new Date(2020, 8, dag2, 13, 55, 0, 0),
        foredragsholder: 'Bouvet',
        beskrivelse:
            '20 minutter er alt for kort tid for å dekke disse to teamene, men jeg skal prøve å gi dere en innblikk i hvordan det er å jobbe som IoT-konsulent i 2020.',
        link: zoomlinkdag2,
    ...
    },
    {
        ...
        beskrivelse:
            'Trenger du en introduksjon til universell utforming, eller har du kanskje jobbet med UU og aldri fått helt grepet på det? Kanskje lurer du på hvorfor staten trer slike skrivebordsregler ned over hodet på oss?',
        link: zoomlinkdag2,
    ...
    },
    {
        ...
        beskrivelse:
            'Tenk deg at du kommer inn i et team som har tilgang på folks ekte persondata. Du har selvfølgelig hørt om GDPR og vet at disse dataene ikke må komme på avveie. Men hvilket ansvar har akkurat du for å sørge for at det ikke skjer? Hva må du huske på for å unngå å havne på forsida til VG? Denne presentasjonen gir en oversikt over ditt ansvar relatert til sikkerhet og andre aspekter, og den gir en del konkrete tips og råd om hva du bør gjøre.',
        link: zoomlinkdag2,
    ...
    },
    {
        ...
        beskrivelse:
            'Dyp læring er den viktigste metoden bak det vi kaller kunstig intelligens. Hva er dyp læring? Hvordan virker denne teknologien og hva kan man få til ved å bruke dette til bildegjenkjenning?',
        link: zoomlinkdag2,
    ...
    },
    {
        ...
        id: 23,
        tittel:
            'Hvordan maskinlæring kan brukes til å sikre finansieringen av velferdssamfunnet',
        start: new Date(2020, 8, dag2, 16, 0, 0, 0),
        slutt: new Date(2020, 8, dag2, 16, 25, 0, 0),
        foredragsholder: 'Skatteetaten',
        beskrivelse:
            'I Skatteetaten jobber vi med alt fra å kreve inn skatter og avgifter til å ha ansvaret for et oppdatert folkeregister. Som et av Norges største IT-miljøer liker vi å ligge i front når det kommer til ny teknologi – det til tross våre statlige gener!\n\nVi ønsker å gi dere en introduksjon til hvordan vi i Skatteetaten bruker maskinlæring til å gjøre det så enkelt som mulig å gjøre rett, og til å sikre finansiering av velferdssamfunnet.',
        link: zoomlinkdag2,
    ...
    },
    {
        ...
        beskrivelse:
            'Kyrre Lekve, Deputy Managing Director ved Simula Research Laboratory, forteller om utviklingen av Smittestopp-appen. Han vil blant annet snakke om tekniske utfordringer og løsninger, forskjellen på kontaktsporing mellom individer og sporing av epidemien på samfunnsnivå, samt hensyn til personvern.\nForedraget vil være av interesse for både bachelor- og masterstudenter, der både tekniske og samfunnsmessige aspekter blir belyst.',
        link: zoomlinkdag2,
    ...
    },
    {
        ...
        foredragsholder: 'DNB',
        beskrivelse:
            'Vanligvis består et team av 6 - 10 personer. Hvordan lager man da én nettside når man er flere hundre utviklere? Vi tar en titt i verktøykassa til de største bedriftene, og ser på hvordan arkitekturen kan se ut, hvordan de jobber og hva slags verktøy de bruker. Kort sagt, hvordan de får alt til å henge sammen, og hvordan vi har valgt å løse det i DNB.',
        link: zoomlinkFdag2,
        bilde: 'dnb_sjogronn.png',
        alt_tekst: 'Dnb-logo',
    },
