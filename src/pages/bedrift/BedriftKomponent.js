  ...
  return (
    ...
    >
      <Container>
        ...
        ></img>
        <div
          style={{ gridArea: "Zoom", justifySelf: "center", padding: "1em" }}
        >
          <Zoom link={bedrift.zoom} text={"Møt oss på Zoom!"} />
        </div>

        <h2 style={{ gridArea: "Title" }}>Hvem er vi?</h2>
        <p style={{ gridArea: "Description" }}>{bedrift.description}</p>
        <ReactPlayer
          url={bedrift.video}
          // width="426px"
          // height="240px"
        ...
        <p style={{ gridArea: "Competition" }}>
          <h3>Konkurranse</h3>
          <a href={bedrift.competition.link}>{bedrift.competition.text}</a>
        </p>
