...
var deserialize = value => (0, _legacy.parse)(value, VALUE_FORMAT);

var serialize = date => (0, _legacy.format)(date, VALUE_FORMAT);
...
var DateInput = /*#__PURE__*/_react.default.forwardRef(function DateInput(props, forwardedRef) {
  ...
  var formatInputValue = _react.default.useCallback(date => (0, _legacy.format)(date, dateFormat), [dateFormat]);

  var parseInputValue = _react.default.useCallback(inputValue => (0, _legacy.parse)(inputValue, dateFormat), [dateFormat]);
