...
export declare type IconSymbol = 'activity' | 'add-circle' | 'add' | 'api' | 'archive' | 'arrow-down' | 'arrow-left' | 'arrow-right' | 'arrow-top-right' | 'arrow-up' | 'bell' | 'bill' | 'binary-document' | 'block-element' | 'blockquote' | 'bold' | 'book' | 'bottle' | 'bulb-filled' | 'bulb-outline' | 'calendar' | 'chart-upward' | 'checkmark-circle' | 'checkmark' | 'chevron-down' | 'chevron-left' | 'chevron-right' | 'chevron-up' | 'circle' | 'clipboard' | 'clipboard-image' | 'clock' | 'close-circle' | 'close' | 'code-block' | 'code' | 'cog' | 'collapse' | 'comment' | 'component' | 'compose' | 'controls' | 'copy' | 'dashboard' | 'database' | 'document' | 'document-remove' | 'documents' | 'download' | 'drag-handle' | 'drop' | 'earth-americas' | 'earth-globe' | 'edit' | 'ellipsis-horizontal' | 'ellipsis-vertical' | 'envelope' | 'equal' | 'error-filled' | 'error-outline' | 'expand' | 'eye-closed' | 'eye-open' | 'folder' | 'generate' | 'heart' | 'help-circle' | 'home' | 'ice-cream' | 'image' | 'image-remove' | 'images' | 'info-filled' | 'info-outline' | 'inline-element' | 'italic' | 'joystick' | 'launch' | 'leave' | 'lemon' | 'link' | 'link-removed' | 'lock' | 'master-detail' | 'menu' | 'mobile-device' | 'moon' | 'ok-hand' | 'olist' | 'overage' | 'package' | 'pause' | 'pin' | 'pin-removed' | 'play' | 'plug' | 'publish' | 'read-only' | 'remove-circle' | 'remove' | 'reset' | 'restore' | 'retrieve' | 'revert' | 'robot' | 'rocket' | 'search' | 'select' | 'sort' | 'spinner' | 'split-horizontal' | 'split-vertical' | 'square' | 'stack-compact' | 'star' | 'strikethrough' | 'sun' | 'sync' | 'terminal' | 'th-large' | 'th-list' | 'toggle-arrow-right' | 'token' | 'trash' | 'trend-upward' | 'triangle-outline' | 'truncate' | 'ulist' | 'underline' | 'undo' | 'unknown' | 'unlock' | 'unpublish' | 'upload' | 'user' | 'users' | 'warning-filled' | 'warning-outline';
export { ActivityIcon, AddCircleIcon, AddIcon, ApiIcon, ArchiveIcon, ArrowDownIcon, ArrowLeftIcon, ArrowRightIcon, ArrowTopRightIcon, ArrowUpIcon, BellIcon, BillIcon, BinaryDocumentIcon, BlockElementIcon, BlockquoteIcon, BoldIcon, BookIcon, BottleIcon, BulbFilledIcon, BulbOutlineIcon, CalendarIcon, ChartUpwardIcon, CheckmarkCircleIcon, CheckmarkIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, CircleIcon, ClipboardIcon, ClipboardImageIcon, ClockIcon, CloseCircleIcon, CloseIcon, CodeBlockIcon, CodeIcon, CogIcon, CollapseIcon, CommentIcon, ComponentIcon, ComposeIcon, ControlsIcon, CopyIcon, DashboardIcon, DatabaseIcon, DocumentIcon, DocumentRemoveIcon, DocumentsIcon, DownloadIcon, DragHandleIcon, DropIcon, EarthAmericasIcon, EarthGlobeIcon, EditIcon, EllipsisHorizontalIcon, EllipsisVerticalIcon, EnvelopeIcon, EqualIcon, ErrorFilledIcon, ErrorOutlineIcon, ExpandIcon, EyeClosedIcon, EyeOpenIcon, FolderIcon, GenerateIcon, HeartIcon, HelpCircleIcon, HomeIcon, IceCreamIcon, ImageIcon, ImageRemoveIcon, ImagesIcon, InfoFilledIcon, InfoOutlineIcon, InlineElementIcon, ItalicIcon, JoystickIcon, LaunchIcon, LeaveIcon, LemonIcon, LinkIcon, LinkRemovedIcon, LockIcon, MasterDetailIcon, MenuIcon, MobileDeviceIcon, MoonIcon, OkHandIcon, OlistIcon, OverageIcon, PackageIcon, PauseIcon, PinIcon, PinRemovedIcon, PlayIcon, PlugIcon, PublishIcon, ReadOnlyIcon, RemoveCircleIcon, RemoveIcon, ResetIcon, RestoreIcon, RetrieveIcon, RevertIcon, RobotIcon, RocketIcon, SearchIcon, SelectIcon, SortIcon, SpinnerIcon, SplitHorizontalIcon, SplitVerticalIcon, SquareIcon, StackCompactIcon, StarIcon, StrikethroughIcon, SunIcon, SyncIcon, TerminalIcon, ThLargeIcon, ThListIcon, ToggleArrowRightIcon, TokenIcon, TrashIcon, TrendUpwardIcon, TriangleOutlineIcon, TruncateIcon, UlistIcon, UnderlineIcon, UndoIcon, UnknownIcon, UnlockIcon, UnpublishIcon, UploadIcon, UserIcon, UsersIcon, WarningFilledIcon, WarningOutlineIcon, };
