...
},{"./middleware/defaultOptionsProcessor":10,"./middleware/defaultOptionsValidator":11,"./request":18,"./util/middlewareReducer":20,"nano-pubsub":22}],10:[function(require,module,exports){
...
},{"is-plain-object":21,"object-assign":26}],13:[function(require,module,exports){
...
"use strict";var generateHelpUrl=require("@sanity/generate-help-url"),assign=require("object-assign"),validate=require("./validators"),warnings=require("./warnings"),defaultCdnHost="apicdn.sanity.io",defaultConfig={apiHost:"https://api.sanity.io",apiVersion:"1",useProjectHostname:!0,gradientMode:!1,isPromiseAPI:!0},LOCALHOSTS=["localhost","127.0.0.1","0.0.0.0"],isLocal=function(n){return-1!==LOCALHOSTS.indexOf(n)};exports.defaultConfig=defaultConfig,exports.initConfig=function(n,e){var i=assign({},e,n);i.apiVersion||warnings.printNoApiVersionSpecifiedWarning();var o=assign({},defaultConfig,i),t=o.gradientMode,a=!t&&o.useProjectHostname;if("undefined"==typeof Promise){var r=generateHelpUrl("js-client-promise-polyfill");throw new Error("No native Promise-implementation found, polyfill needed - see ".concat(r))}if(t&&!o.namespace)throw new Error("Configuration must contain `namespace` when running in gradient mode");if(a&&!o.projectId)throw new Error("Configuration must contain `projectId`");var s="undefined"!=typeof window&&window.location&&window.location.hostname,d=s&&isLocal(window.location.hostname);if(s&&d&&o.token&&!0!==o.ignoreBrowserTokenWarning?warnings.printBrowserTokenWarning():(!s||d)&&o.useCdn&&o.token?warnings.printCdnTokenWarning():void 0===o.useCdn&&warnings.printCdnWarning(),a&&validate.projectId(o.projectId),!t&&o.dataset&&validate.dataset(o.dataset,o.gradientMode),o.apiVersion="".concat(o.apiVersion).replace(/^v/,""),o.isDefaultApi=o.apiHost===defaultConfig.apiHost,o.useCdn=Boolean(o.useCdn)&&!o.token&&!o.withCredentials,exports.validateApiVersion(o.apiVersion),o.gradientMode)o.url=o.apiHost,o.cdnUrl=o.apiHost;else{var c=o.apiHost.split("://",2),p=c[0],l=c[1],u=o.isDefaultApi?defaultCdnHost:l;o.useProjectHostname?(o.url="".concat(p,"://").concat(o.projectId,".").concat(l,"/v").concat(o.apiVersion),o.cdnUrl="".concat(p,"://").concat(o.projectId,".").concat(u,"/v").concat(o.apiVersion)):(o.url="".concat(o.apiHost,"/v").concat(o.apiVersion),o.cdnUrl=o.url)}return o},exports.validateApiVersion=function(n){if("1"!==n&&"X"!==n){var e=new Date(n);if(!(/^\d{4}-\d{2}-\d{2}$/.test(n)&&e instanceof Date&&e.getTime()>0))throw new Error("Invalid API version string, expected `1` or date in format `YYYY-MM-DD`")}};
